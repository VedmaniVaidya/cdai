...
for i in range(1,21):
    url=f"https://www.w3resource.com/python-exercises/pandas/missing-values/python-pandas-missing-values-exercise-{i}.php"
...
fname = 'notebooks/pandas_missing_data.ipynb'
